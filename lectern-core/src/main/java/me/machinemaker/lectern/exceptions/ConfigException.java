...
public abstract class ConfigException extends RuntimeException {
    ...
    protected ConfigException(@NotNull String message, @Nullable ConfigurationNode config, @NotNull Throwable cause) {
        super(message, cause);
        this.config = config;
    }

    protected ConfigException(@NotNull String message, @NotNull ConfigurationNode config) {
        super(message);
        this.config = config;
    }

    protected ConfigException(@NotNull ConfigurationNode config, @NotNull Throwable cause) {
